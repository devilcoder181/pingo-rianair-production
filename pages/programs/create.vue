            ...
            <div class="p-col-9">
                <div class="p-content-body">
                    <div class="p-row">
                        ...
                        <div class="p-col">
                            <AdminFormPingoInput :text.sync="programContent.title" title="Program Title"></AdminFormPingoInput>
                        </div>

                        <div class="p-col">
                            <AdminFormPingoTextarea :text.sync="programContent.description" title="Program Description"></AdminFormPingoTextarea>
                        </div>
...
export default {
    ...
    methods: {
        getURL(value) {
            this.programContent.image = value
        },
        async submit() {
            try{
            this.$store.commit('activateLoader', true)
            this.$store.dispatch('addProgram', this.programContent)
